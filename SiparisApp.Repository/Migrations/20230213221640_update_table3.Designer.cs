...
namespace SiparisApp.Repository.Migrations
{
    ...
    [Migration("20230213221640_update_table3")]
            ...
            modelBuilder.Entity("SiparisApp.Core.Model.OrderStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 2, 14, 1, 16, 39, 219, DateTimeKind.Local).AddTicks(6227),
                            Name = "Sipariş Alındı",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 2, 14, 1, 16, 39, 219, DateTimeKind.Local).AddTicks(6257),
                            Name = "Yola Çıktı",
                            UpdateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 2, 14, 1, 16, 39, 219, DateTimeKind.Local).AddTicks(6264),
                        ...
                        {
                            Id = 4,
                            CreateDate = new DateTime(2023, 2, 14, 1, 16, 39, 219, DateTimeKind.Local).AddTicks(6271),
                            Name = "Teslim Edildi",
                            UpdateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 5,
                            CreateDate = new DateTime(2023, 2, 14, 1, 16, 39, 219, DateTimeKind.Local).AddTicks(6277),
